...
namespace IRIS.Serial.Recognition
{
    ...
    ///     </para>
    ///     <para>
    ///         This watcher is primarily provided for backward compatibility and basic scenarios. For most production use
    ///         cases,
    ///         <see cref="WindowsUSBSerialPortDeviceWatcher" /> provides more reliable device detection by filtering for
    ///         specific USB hardware identifiers.
    ///     </para>
    /// </summary>
    /// <remarks>
    ...
    public sealed class SerialPortDeviceWatcher : DeviceWatcherBase<SerialPortDeviceWatcher, SerialPortDeviceAddress>
    {
        ...
        ///     Token to monitor for cancellation requests. Note: This operation is synchronous and
